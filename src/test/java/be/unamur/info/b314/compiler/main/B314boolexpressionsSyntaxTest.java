...
public class B314boolexpressionsSyntaxTest {
    ...
    @Test
    public void testboolexpressions_operations_ko() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/boolexpressions/ko/operationko", testFolder.newFile(), false, "boolexpressions: operations");
    }
    @Test
    public void testboolexpressions_operations_ko2() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/boolexpressions/ko/operationko2", testFolder.newFile(), false, "boolexpressions: operations");
    }
    @Test
    ...
    @Test
    public void testboolexpressions_operations_ko3() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/boolexpressions/ko/operationko3", testFolder.newFile(), false, "boolexpressions: operations");
    }
    @Test
    public void testboolexpressions_operations_ko4() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/boolexpressions/ko/operationko4", testFolder.newFile(), false, "boolexpressions: operations");
    }
